...
function createTemplateForEditPoint(point) {
  const {city, pointType, time, price, pointInfo} = point;

  let startTime = dayjs(time.startDate).format(`DD/MM/YY[&nbsp;]HH:mm`);
  let endTime = dayjs(time.endDate).format(`DD/MM/YY[&nbsp;]HH:mm`);
